...
module Notifiable
  class Sender    
    ...
    def send_notification_to_users(user_aliases, title: nil, message: nil, parameters: nil, content_available: nil, thread_id: nil, mutable_content: nil)
      ...
      filters = [{property: "user_alias", predicate: "in", value: user_aliases}]
      send_notification(title: title, message: message, parameters: parameters, content_available: content_available, filters: filters, thread_id: thread_id, mutable_content: mutable_content)
    end
    
    def send_notification_to_user(user_alias, title: nil, message: nil, parameters: nil, content_available: nil, thread_id: nil, mutable_content: nil)
    ...
    def send_notification(title: nil, message: nil, parameters: nil, filters: nil, content_available: nil, thread_id: nil, mutable_content: nil)
      body = {}
